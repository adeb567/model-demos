...
from demo3.models.bilinear_upsampling import BilinearUpsampling
from demo3.models.vgg_en_dec import plain_vgg_en_dec
...
def SVAM_Net(res=(256, 256, 3), model_h5=None):
    ...
    conv2d_1, dec5 = model.get_layer('conv2d').output, model.get_layer('concatenate').output
    conv2d_2, dec4 = model.get_layer('conv2d_1').output, model.get_layer('concatenate_1').output
    conv2d_3, dec3 = model.get_layer('conv2d_2').output, model.get_layer('concatenate_2').output
    conv2d_4, dec2 = model.get_layer('conv2d_3').output, model.get_layer('concatenate_3').output
    dec1, dec0 = model.get_layer('up_sampling2d_4').output, model.get_layer('output').output
    # get SAM outputs
