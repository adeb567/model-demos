...
## local libs
from demo1.utils.data_utils import preprocess, deprocess

from flask import Blueprint

app1_bp = Blueprint('app1', __name__, static_url_path='/static')

@app1_bp.route('/app1')
def app1_route():
    return render_template("index1.html")

@app1_bp.route("/app1/process", methods=["POST"])
def process_image():
    ...
    ## test funie-gan
    checkpoint_dir  = '/home/amitabha/demos/Integrated/demo1/models/gen_p/'
    ...
    return render_template("display1.html", input = input, output = output)
